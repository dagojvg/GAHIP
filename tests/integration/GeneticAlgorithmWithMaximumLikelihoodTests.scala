...
class GeneticAlgorithmWithMaximumLikelihoodTests {

  @Test
  def runGeneticAlgorithm_whenReadingGenotypesFromFileAndUsingMaximumLikelihood_returnsSolutions() ={
